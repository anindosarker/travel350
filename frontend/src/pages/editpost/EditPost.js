        ...
        <div className=" mt-6 bg-white w-11/12 rounded-md flex flex-col">
          <div className="w-full flex justify-between">
            <div className="w-6/12">
              <h2 className="ml-6 mt-6 text-[22px]">Edit place name:</h2>
              <input
                type="text"
            ...
            <div className="mt-12 ml-[800px] absolute">
              ...
              {open && (
                <>
                  ...
                  <div
                    className=" flex w-full bg-slate-300 hover:bg-slate-500"
                    onClick={() => handleClick("tourist blog")}
                  >
                    <a href="#">Food</a>
                  </div>
                  <div
                  ...
                  <div
                    className="flex w-full bg-slate-300 hover:bg-slate-500"
                    onClick={() => handleClick("travel community")}
                  >
                    <a href="#">Others</a>
                  </div>
                </>
          ...
          <h2 className="ml-6 mt-6 text-[22px]">Edit username:</h2>
          <input
            type="text"
          ...
          <div className="ml-6 mt-6">
            ...
            Edit which forums the post is shown in:
            </h2>
            {forums.map((singleForum, index) => (
              <>
                <div key={index} className="flex flex-col mt-5">
                  <div className="flex">
                    <input
                      ...
                      id="forum"
                      className="border-2 border-gray-500 rounded-md px-1"
                      value={singleForum.forum}
                      onChange={(e) => handleforumchange(e, index)}
                    />
                    {forums.length > 1 && (
                      <button
                        className="ml-4 bg-red-600 text-white px-2 py-1 rounded-md"
                        onClick={handleremoveforum}
                      >
                        remove
                      </button>
                    )}
                  </div>
                  {forums.length - 1 === index && (
                    <button
                      className="mt-3 ml-3 bg-blue-600 text-white px-2 py-1 rounded-md w-[100px]"
            ...
            {forums.map((singleForum, index) => (
              <ul className="mt-5 bg-blue-300 w-[150px]" key={index}>
                {<li>{singleForum.forum}</li>}
              </ul>
            ))}
          </div>
          <h2 className="ml-6 mt-6 text-[22px]">Edit place summary:</h2>
          <textarea
            type="text"
            className="w-6/12 ml-6 mt-3 shadow-md hover:shadow-xl bg-slate-100 rounded-md p-1 h-[150px]"
          />
          <h2 className="ml-6 mt-3 text-[22px]">Edit place images:</h2>
